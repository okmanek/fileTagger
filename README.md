this application was created to enable tagging files on linux on filesystem not adapted to tagging (e.g. ext4). I checked some existing programs and I wasn't quite content with what they offered:
